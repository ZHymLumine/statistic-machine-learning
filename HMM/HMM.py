...
if __name__ == '__main__':
    ...
    #依据现有训练集统计PI、A、B
    PI, A, B = trainParameter('D:\\WORKSPACE\\statistic-machine-learning\\HMM\\HMMTrainSet.txt')

    #读取测试文章
    article = loadArticle('D:\\WORKSPACE\\statistic-machine-learning\\HMM\\testArticle.txt')
