...
def test(trainDataArr, trainLabelArr, testDataArr, testLabelArr, topK):
    ...
    # print(np.shape(trainDataArr))
    # print(np.shape(trainLabelArr))
    # print(np.shape(trainDataMat))
    # print(np.shape(trainLabelMat))
  
    # print(np.shape(trainDataMat[0]))
    # print(trainDataArr[0][0])
    #错误值技术
    errorCnt = 0
    #遍历测试集，对每个测试集样本进行测试
